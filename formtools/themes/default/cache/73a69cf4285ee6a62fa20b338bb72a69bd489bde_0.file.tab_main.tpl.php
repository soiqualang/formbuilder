...
/* Smarty version 3.1.31, created on 2018-08-16 09:16:40
  from "D:\sync\websvr\xampp\formbuilder\formtools\themes\default\admin\settings\tab_main.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5b7524d89f2c76_50151454',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '73a69cf4285ee6a62fa20b338bb72a69bd489bde' => 
    array (
      0 => 'D:\\sync\\websvr\\xampp\\formbuilder\\formtools\\themes\\default\\admin\\settings\\tab_main.tpl',
      1 => 1534170618,
      2 => 'file',
    ),
  ),
...
function content_5b7524d89f2c76_50151454 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <tr>
      ...
      <td>
        <select name="default_date_field_search_value">
          <option value="none" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "none") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_none'];?>
</option>
          <option value="today" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "today") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_today'];?>
</option>
          <option value="last_7_days" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "last_7_days") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_last_7_days'];?>
</option>
          <option value="month_to_date" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "month_to_date") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_month_to_date'];?>
</option>
          <option value="year_to_date" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "year_to_date") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_year_to_date'];?>
</option>
          <option value="previous_month" <?php if ($_smarty_tpl->tpl_vars['settings']->value['default_date_field_search_value'] == "previous_month") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_the_previous_month'];?>
</option>
        </select>
      </td>
    </tr>
